...
import { modulePages } from "@/data/modules.js";
import { paths } from "@/config/paths.js";

export function generateStaticParams() {
  return Object.keys(modulePages).map((slug) => ({ locale: "en", slug }));
}
  ...
  return (
    <article className="border-b border-zinc-200 bg-white py-14 sm:py-16">
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
        <Link href={paths.section("modules")} className="text-sm font-semibold text-brand-accent-dim hover:underline">
          ← All modules
        </Link>
