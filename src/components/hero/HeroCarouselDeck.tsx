  ...
  return (
    <div className="dm-hero__deck" onTouchStart={onTouchStart} onTouchEnd={onTouchEnd}>
      <div className="dm-hero__right-stack">
        <div className="dm-hero__mockup-cluster">
              ...
              >
                {active ? (
                  <HeroModuleDashboard
                    ...
                    preview={false}
                    mockupMode={slide.mockupMode}
                    mockupModule={slide.mockupModule}
                    mockupData={slide.mockupData}
                    mockupImage={slide.mockupImage ?? slide.dashboardImageUrl}
                    mockupAltText={slide.mockupAltText}
                    mockupVisible={slide.mockupVisible}
                  />
                ) : null}
              </div>
            )
